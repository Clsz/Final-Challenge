...
class ConstantManager{
    ...
    static var location = ["Tangerang","Tangerang Selatan", "Jakarta Barat","Jakarta Pusat","Jakarta Timur","Jakarta Selatan","Jakarta Utara", "Cibubur", "Cilegon"]
    static var province = ["Banten", "Jakarta"]
    ...
    static let day = ["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday","Weekdays"]
